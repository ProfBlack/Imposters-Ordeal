...
namespace ImpostersOrdeal
{
    ...
    public static class GlobalData
    {
        ...
        public enum MonoType
        {
            ...
            UgMiniMapComponent,
            UgEncount,
            UgDrillUsablePositions,
            UgFieldManager,
            UgNpcPos,
            UgDigFossilePosGroups,
            UgTamagoWazaIgnoreTable,
            UgNpcTalk,
            UgMiniMap,
            StatueBuff,
            UIStatueBuffIcon,
            ...
            // battle_masterdatas
            BattleDataTable,
            BattleWaitCameraData,
            BattleDefaultPlacementData,
            BattleSetupEffectLots,
